...
|----------|------------|---------------------------------|
| **Phase 1: Data Preparation & Baseline Modeling** | **Month 1** | <br> ✅ Curate multi-spectral datasets (EO-1 Hyperion, KAIST, KITTI)  <br><br> ✅ Preprocess raw data (noise reduction, spectral alignment, temporal synchronization) <br><br> ✅ Implement baseline **monocular & stereo depth estimation models** for benchmarking <br> |
